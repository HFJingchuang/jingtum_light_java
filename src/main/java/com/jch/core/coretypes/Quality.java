...
public class Quality {
	/**
	 * Finds the quality (TakerPays/TakerGets) ratio packed into the last 64 bits of
	 * root DirectoryNode ledger indexes.
	 */
	public static BigDecimal fromBookDirectory(Hash256 bookDirectory, boolean payIsNative, boolean getIsNative) {
		...
		int scale = -(payIsNative ? exponent - 6 : getIsNative ? exponent + 6 : exponent);
