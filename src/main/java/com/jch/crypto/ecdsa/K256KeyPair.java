...
public class K256KeyPair implements IKeyPair {
	 ...
	 * @return the corresponding public key is the public generator (aka public root
	 *         key, master public key). return as byte[] for convenience.
	 */
	...
	/**
	 * @param seedBytes     - a bytes sequence of arbitrary length which will be
	 *                      hashed
